...
<div class="row">
    <div class="col-md-12">
        ...
        {!! Form::open(['route' => 'admin.user.role.store', 'id'=>'content_form','files' => true, 'method' => 'POST']) !!}
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td>
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input {{$key}}" type="checkbox" id="{{$per}}" multiple="multiple" name="permissions[]" value="{{$per}}">
        ...
        <div class="row">
            <div class="col-md-6 mx-auto text-center">
                ...
                {{ Form::submit(_lang('Set Permission'), ['class' => 'btn btn-outline btn-success btn-round btn-wd w-100 ', 'id' => 'submit']) }}
