@extends('layouts.master', ['title' => __('Supplier'), 'modal' => 'lg'])
@section('content')
<div class="row">
    <div class="col-md-12">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a id="content_managment" data-url="{{ route('admin.supplier.edit',$model->id) }}" class="btn btn-link btn-warning edit">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <a href="" id="delete_item" data-id ="{{$model->id}}" data-url="{{route('admin.supplier.destroy',$model->id) }}" class="btn btn-link btn-danger remove">
